...
write_stage_session_info("40_find_markers_starsolo")
...
outfile <- file.path(outdir, "pbmc1k_starsolo_markers.tsv")
...
topfile <- file.path(outdir, "pbmc1k_starsolo_top10_markers.tsv")
